...
class Seq2Seq(nn.Module):
    ...
    def forward(
        ...
        # Make contiguous and detach to ensure proper device placement for DataParallel
        last_enc_consumption = enc_x[:, -1:, 0:1].contiguous()  # [B, 1, 1]
        last_enc_consumption = last_enc_consumption.squeeze(1)  # [B, 1]
